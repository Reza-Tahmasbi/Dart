...
class $AssetsFontsGen {
  ...
  /// List of all assets
  List<String> get values => [montserratBold, montserratRegular];
}
...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/pool.svg
  SvgGenImage get pool => const SvgGenImage('assets/icons/pool.svg');

  /// File path: assets/icons/wifi.png
  AssetGenImage get wifi => const AssetGenImage('assets/icons/wifi.png');

  /// List of all assets
  List<dynamic> get values => [heart, bath, food, pool, wifi];
}
...
class $AssetsImagesGen {
  ...
  /// List of all assets
  List<AssetGenImage> get values => [buildings];
}
